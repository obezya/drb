...
const iconMenuu = document.querySelector('.icon__menu');
const menuBodyy = document.querySelector('.header__menu');
if(iconMenuu){
	iconMenuu.addEventListener("click", function(e) {
		document.body.classList.toggle("_lock");
		iconMenuu.classList.toggle('_active');
		menuBodyy.classList.toggle('_active');
	});
}
...
if(menuLinks.length>0){
	...
	function onMenuLinkClick(e){
		...
		if(menuLink.dataset.goto && document.querySelector(menuLink.dataset.goto)){
			...
			if(iconMenuu.classList.contains('_active')){
				document.body.classList.remove("_lock");
				iconMenuu.classList.remove('_active');
				menuBodyy.classList.remove('_active');
			}
...
$(document).ready(function(){
	$('.articles-page__content').click(function(event){
